...
```bash
python evaluate/evaluate_rag.py           # naive RAG
python evaluate/evaluate_router_full.py   # router RAG 전체 파이프라인
python evaluate/evaluate_agentic.py       # agentic RAG 전체 파이프라인
python evaluate/evaluate_refusal.py       # refusal 처리
python evaluate/evaluate_robustness.py    # 강건성
```

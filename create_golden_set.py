...
SINGLE_TEMPLATES = [
    ...
    {"id": "S001", "question": "이번 시즌 인터셉트가 가장 많은 미드필더는?",
     "position": "MF", "metric": "Interceptions", "top_n": 3},
    {"id": "S002", "question": "태클 횟수가 가장 많은 미드필더는?",
     "position": "MF", "metric": "Tackles", "top_n": 3},
    {"id": "S003", "question": "프로그레시브 캐리가 가장 많은 미드필더는?",
     "position": "MF", "metric": "Progressive Carries", "top_n": 3},
    {"id": "S004", "question": "어시스트가 가장 많은 미드필더는?",
     "position": "MF", "metric": "Assists", "top_n": 3},
    {"id": "S005", "question": "패스 성공률이 가장 높은 미드필더는?",
     "position": "MF", "metric": "Passes%", "top_n": 3},
    {"id": "S006", "question": "이번 시즌 가장 많이 뛴 미드필더는?",
     "position": "MF", "metric": "Minutes", "top_n": 3},
    {"id": "S007", "question": "볼 점유 획득 횟수가 가장 많은 미드필더는?",
     "position": "MF", "metric": "Possession Won", "top_n": 3},
    {"id": "S008", "question": "골을 가장 많이 넣은 미드필더는?",
     "position": "MF", "metric": "Goals", "top_n": 3},
    # DF
    {"id": "S009", "question": "태클 횟수가 가장 많은 수비수는?",
     "position": "DF", "metric": "Tackles", "top_n": 3},
    {"id": "S010", "question": "인터셉트가 가장 많은 수비수는?",
     "position": "DF", "metric": "Interceptions", "top_n": 3},
    {"id": "S011", "question": "클리어런스가 가장 많은 수비수는?",
     "position": "DF", "metric": "Clearances", "top_n": 3},
    {"id": "S012", "question": "공중 듀얼 승률이 가장 높은 수비수는?",
     "position": "DF", "metric": "aDuels %", "top_n": 3},
    {"id": "S013", "question": "패스 성공률이 가장 높은 수비수는?",
     "position": "DF", "metric": "Passes%", "top_n": 3},
    # FW
    {"id": "S014", "question": "골을 가장 많이 넣은 공격수는?",
     "position": "FW", "metric": "Goals", "top_n": 3},
    {"id": "S015", "question": "슈팅 성공률이 가장 높은 공격수는?",
     "position": "FW", "metric": "Conversion %", "top_n": 3},
    {"id": "S016", "question": "어시스트가 가장 많은 공격수는?",
     "position": "FW", "metric": "Assists", "top_n": 3},
    {"id": "S017", "question": "프로그레시브 캐리가 가장 많은 공격수는?",
     "position": "FW", "metric": "Progressive Carries", "top_n": 3},
    # GK
    {"id": "S018", "question": "이번 시즌 가장 많이 뛴 골키퍼는?",
     "position": "GK", "metric": "Minutes", "top_n": 3},
    {"id": "S019", "question": "세이브 횟수가 가장 많은 골키퍼는?",
     "position": "GK", "metric": "Saves", "top_n": 3},
    {"id": "S020", "question": "클린시트가 가장 많은 골키퍼는?",
     "position": "GK", "metric": "Clean Sheets", "top_n": 3},
]
...
def build_complex(df: pd.DataFrame) -> list[dict]:
    ...
    # C001
    sub = df[(df["Position"] == "MF") & (df["Passes%"] >= 80)]
    top = sub.nlargest(3, "Tackles")["Player Name"].tolist()
    results.append({
        "id": "C001", "type": "complex",
        "question": "패스 성공률 80% 이상이면서 태클도 많은 미드필더는?",
        "expected_players": top,
        "conditions": {"position": "MF", "Passes%_min": 80, "sort_by": "Tackles"},
    })

    # C002
    sub = df[(df["Position"] == "MF") & (df["Interceptions"] >= df[df["Position"] == "MF"]["Interceptions"].quantile(0.5))]
    ...
    results.append({
        ...
        "expected_players": top,
        "conditions": {"position": "MF", "Interceptions_min_percentile": 50, "sort_by": "Progressive Carries"},
    })

    # C003
    sub = df[(df["Position"] == "DF") & (df["Tackles"] >= df[df["Position"] == "DF"]["Tackles"].quantile(0.5))]
    top = sub.nlargest(3, "Interceptions")["Player Name"].tolist()
    results.append({
        "id": "C003", "type": "complex",
        "question": "태클과 인터셉트가 모두 높은 수비수는?",
        "expected_players": top,
        "conditions": {"position": "DF", "Tackles_min_percentile": 50, "sort_by": "Interceptions"},
    })

    # C004
    sub = df[(df["Position"] == "FW") & (df["Goals"] >= 5)]
    top = sub.nlargest(3, "Assists")["Player Name"].tolist()
    results.append({
        "id": "C004", "type": "complex",
        "question": "골도 5개 이상이면서 어시스트도 많은 공격수는?",
        "expected_players": top,
        "conditions": {"position": "FW", "Goals_min": 5, "sort_by": "Assists"},
    })

    # C005
    sub = df[(df["Position"] == "MF") & (df["Minutes"] >= 1800)]
    top = sub.nlargest(3, "Goals")["Player Name"].tolist()
    results.append({
        "id": "C005", "type": "complex",
        "question": "주전(1800분 이상)으로 뛰면서 골도 많이 넣은 미드필더는?",
        "expected_players": top,
        "conditions": {"position": "MF", "Minutes_min": 1800, "sort_by": "Goals"},
    })

    # C006
    sub = df[(df["Position"] == "DF") & (df["Passes%"] >= 85)]
    top = sub.nlargest(3, "Progressive Carries")["Player Name"].tolist()
    results.append({
        "id": "C006", "type": "complex",
        "question": "패스 성공률 85% 이상의 빌드업 능력 있는 수비수는?",
        "expected_players": top,
        "conditions": {"position": "DF", "Passes%_min": 85, "sort_by": "Progressive Carries"},
    })

    # C007
    sub = df[(df["Position"] == "MF") & (df["Tackles"] >= df[df["Position"] == "MF"]["Tackles"].quantile(0.6))]
    top = sub.nlargest(3, "Passes%")["Player Name"].tolist()
    results.append({
        "id": "C007", "type": "complex",
        "question": "압박과 태클이 강하면서 패스 정확도도 높은 미드필더는?",
        "expected_players": top,
        "conditions": {"position": "MF", "Tackles_min_percentile": 60, "sort_by": "Passes%"},
    })

    # C008
    sub = df[(df["Position"] == "FW") & (df["Shots"] >= df[df["Position"] == "FW"]["Shots"].quantile(0.5))]
    top = sub.nlargest(3, "Conversion %")["Player Name"].tolist()
    results.append({
        "id": "C008", "type": "complex",
        "question": "슈팅 시도도 많으면서 전환율도 높은 공격수는?",
        "expected_players": top,
        "conditions": {"position": "FW", "Shots_min_percentile": 50, "sort_by": "Conversion %"},
    })

    # C009
    sub = df[(df["Position"] == "MF") & (df["Fouls"] <= df[df["Position"] == "MF"]["Fouls"].quantile(0.4))]
    top = sub.nlargest(3, "Tackles")["Player Name"].tolist()
    results.append({
        "id": "C009", "type": "complex",
        "question": "파울 없이 클린하게 수비하면서 태클 횟수도 많은 미드필더는?",
        "expected_players": top,
        "conditions": {"position": "MF", "Fouls_max_percentile": 40, "sort_by": "Tackles"},
    })

    # C010
    sub = df[(df["Position"] == "GK") & (df["Minutes"] >= 1800)]
    top = sub.nlargest(3, "Saves %")["Player Name"].tolist()
    results.append({
        "id": "C010", "type": "complex",
        "question": "주전 골키퍼 중 세이브 성공률이 높은 선수는?",
        "expected_players": top,
        "conditions": {"position": "GK", "Minutes_min": 1800, "sort_by": "Saves %"},
    })

    # C011
    sub = df[(df["Position"] == "DF") & (df["Aerial Duels"] >= df[df["Position"] == "DF"]["Aerial Duels"].quantile(0.5))]
    top = sub.nlargest(3, "aDuels %")["Player Name"].tolist()
    results.append({
        "id": "C011", "type": "complex",
        "question": "공중 듀얼 참여도 많고 승률도 높은 수비수는?",
        "expected_players": top,
        "conditions": {"position": "DF", "Aerial Duels_min_percentile": 50, "sort_by": "aDuels %"},
    })

    # C012
    sub = df[(df["Position"] == "MF") & (df["Assists"] >= 3)]
    top = sub.nlargest(3, "Passes%")["Player Name"].tolist()
    results.append({
        "id": "C012", "type": "complex",
        "question": "어시스트 3개 이상이면서 패스 성공률도 높은 창의적인 미드필더는?",
        "expected_players": top,
        "conditions": {"position": "MF", "Assists_min": 3, "sort_by": "Passes%"},
    })

    # C013
    sub = df[(df["Position"] == "FW") & (df["Progressive Carries"] >= df[df["Position"] == "FW"]["Progressive Carries"].quantile(0.5))]
    top = sub.nlargest(3, "Assists")["Player Name"].tolist()
    results.append({
        "id": "C013", "type": "complex",
        "question": "직접 전진하면서 어시스트도 많이 만들어내는 윙어는?",
        "expected_players": top,
        "conditions": {"position": "FW", "Progressive Carries_min_percentile": 50, "sort_by": "Assists"},
    })

    # C014
    sub = df[(df["Position"] == "MF") & (df["Yellow Cards"] <= 3) & (df["Minutes"] >= 1800)]
    top = sub.nlargest(3, "Tackles")["Player Name"].tolist()
    results.append({
        "id": "C014", "type": "complex",
        "question": "주전으로 뛰면서 경고 카드 없이 강한 압박을 하는 미드필더는?",
        "expected_players": top,
        "conditions": {"position": "MF", "Yellow Cards_max": 3, "Minutes_min": 1800, "sort_by": "Tackles"},
    })

    # C015
    sub = df[(df["Position"] == "DF") & (df["Blocks"] >= df[df["Position"] == "DF"]["Blocks"].quantile(0.5))]
    top = sub.nlargest(3, "Clearances")["Player Name"].tolist()
    results.append({
        "id": "C015", "type": "complex",
        "question": "블록과 클리어런스 모두 많은 헌신적인 수비수는?",
        "expected_players": top,
        "conditions": {"position": "DF", "Blocks_min_percentile": 50, "sort_by": "Clearances"},
    })
    ...
    return [
        {
            ...
            "conversation": [
                {"turn": 1, "question": "태클 많은 미드필더 3명 추천해줘",
                 "expected_players": top("MF", "Tackles")},
                {"turn": 2, "question": "그 중에서 패스 성공률이 제일 높은 선수는?",
                 "expected_players": safe_top(top("MF", "Tackles"), "Passes%")},
            ]
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "골 많이 넣은 공격수 알려줘",
                 "expected_players": top("FW", "Goals")},
                {"turn": 2, "question": "그 선수들 소속팀이 어디야?",
                 "expected_players": top("FW", "Goals")},
                {"turn": 3, "question": "그 중 슈팅 성공률이 가장 높은 선수는?",
                 "expected_players": safe_top(top("FW", "Goals"), "Conversion %")},
            ]
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "인터셉트 많은 수비수 추천해줘",
                 "expected_players": top("DF", "Interceptions")},
                {"turn": 2, "question": "그 중 공중 듀얼 승률이 높은 선수는?",
                 "expected_players": safe_top(top("DF", "Interceptions"), "aDuels %")},
            ]
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "주전 골키퍼 중 세이브 많이 한 선수는?",
                 "expected_players": df[(df["Position"] == "GK") & (df["Minutes"] >= 1800)].nlargest(3, "Saves")["Player Name"].tolist()},
        ...
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "어시스트 많은 미드필더 알려줘",
                 "expected_players": top("MF", "Assists")},
                {"turn": 2, "question": "그 중 프로그레시브 캐리도 많은 선수는?",
                 "expected_players": safe_top(top("MF", "Assists"), "Progressive Carries")},
        ...
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "패스 성공률 높은 수비수 추천해줘",
                 "expected_players": top("DF", "Passes%")},
                {"turn": 2, "question": "그 중 가장 많이 뛴 선수는?",
                 "expected_players": safe_top(top("DF", "Passes%"), "Minutes")},
            ]
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "프로그레시브 캐리 많은 미드필더 알려줘",
                 "expected_players": top("MF", "Progressive Carries")},
                {"turn": 2, "question": "그 중 수비 기여도(인터셉트)도 높은 선수가 있어?",
                 "expected_players": safe_top(top("MF", "Progressive Carries"), "Interceptions")},
            ]
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "클리어런스 많은 수비수 3명 알려줘",
                 "expected_players": top("DF", "Clearances")},
                {"turn": 2, "question": "그 중 태클도 많이 하는 선수는?",
                 "expected_players": safe_top(top("DF", "Clearances"), "Tackles")},
        ...
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "슈팅 많이 하는 공격수 추천해줘",
                 "expected_players": top("FW", "Shots")},
                {"turn": 2, "question": "그 중 유효슈팅 비율도 높은 선수는?",
                 "expected_players": safe_top(top("FW", "Shots"), "Shots On Target")},
            ]
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "볼 점유 획득이 많은 미드필더는?",
                 "expected_players": top("MF", "Possession Won")},
        ...
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "태클 강한 수비수 알려줘",
                 "expected_players": top("DF", "Tackles")},
                {"turn": 2, "question": "그 중 경고 카드 적은 선수는?",
                 "expected_players": safe_top(top("DF", "Tackles"), "Yellow Cards", ascending=True)},
            ]
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "이번 시즌 가장 많이 뛴 미드필더는?",
                 "expected_players": top("MF", "Minutes")},
                {"turn": 2, "question": "그 선수 골+어시스트 합산은?",
                 "expected_players": top("MF", "Minutes")[:1]},
            ]
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "세이브율 높은 골키퍼 추천해줘",
                 "expected_players": top("GK", "Saves %")},
                {"turn": 2, "question": "그 중 클린시트도 많은 선수는?",
                 "expected_players": safe_top(top("GK", "Saves %"), "Clean Sheets")},
            ]
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "크로스 성공률 높은 공격수는?",
                 "expected_players": df[df["Position"] == "FW"].nlargest(3, "Crosses %")["Player Name"].tolist()},
        ...
        },
        {
            ...
            "conversation": [
                {"turn": 1, "question": "블록 많이 하는 수비수 알려줘",
                 "expected_players": top("DF", "Blocks")},
                {"turn": 2, "question": "그 중 패스 성공률도 좋은 선수는?",
                 "expected_players": safe_top(top("DF", "Blocks"), "Passes%")},
